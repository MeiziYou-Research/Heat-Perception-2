...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = `
      ...
      /* XLP_ATTENTION_CONTENT_SCALE_V37_START */
      ...
      #scene3-attention-routing .dayheat-stage {
        width: 90% !important;
        height: min(720px, calc(90vh - 108px)) !important;
      ...
      /* XLP_ATTENTION_CONTENT_SCALE_V37_END */
`;
    ...
    return `
      <div class="dayheat-wrap">
        ...
        <div class="dayheat-stage">
          <img class="dayheat-bg" src="${encodePath(BG_PATH)}" alt="Main attention scene background" loading="lazy" decoding="async">
      ...
      <div class="dayheat-modal" id="dayheat-modal" aria-hidden="true">
        <div class="dayheat-modal-panel" role="dialog" aria-modal="true">
          ...
          <div class="dayheat-modal-image">
            <img id="dayheat-modal-img" src="" alt="" decoding="async">
          </div>
      ...
      return `
        ...
        >
          <div class="dayheat-pin-img-wrap">
            <img class="dayheat-pin-thumb" src="${encodePath(sceneImage(scene.code))}" alt="${scene.title}" loading="lazy" decoding="async">
          </div>
