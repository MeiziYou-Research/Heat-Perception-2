...
(function () {
  ...
  function ensure() {
    ...
    /* Preserve the existing node; replacing it can move the scroll anchor. */
    const existingWrapper = document.getElementById("scene5-driver-title-wrapper");
    const existingSection = document.getElementById("scene-driver-title");
  ...
  function boot() {
    if (window.__XLP_SCENE5_DRIVER_TITLE_BOOTED__) return;
    window.__XLP_SCENE5_DRIVER_TITLE_BOOTED__ = true;
